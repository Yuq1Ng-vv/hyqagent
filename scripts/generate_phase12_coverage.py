...
COVERAGE_MAP: dict[str, dict[str, Any]] = {
    ...
    "INPUT-001": {
        ...
        "needs_phase3": {"llm": True, "dynamic": False,
    ...
    "NET-002": {
        ...
        "needs_phase3": {"llm": True, "dynamic": True,
...
def main() -> None:
    ...
    print(f"   Dynamic testing needed: {result['summary']['phase3_needed']['items_requiring_dynamic_testing']}")
